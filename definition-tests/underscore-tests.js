...
_.some([1, 2, 3, 4], function (l) {
    return l % 3 === 0;
});

_.some({ a: 'a', b: 'B', c: 'C', d: 'd' }, function (l) {
    return l === l.toUpperCase();
});
...
var updatePosition = function (param) {
    return alert('updating position... Param: ' + param);
};
var throttled = _.throttle(updatePosition, 100);
$(window).scroll(throttled);

var calculateLayout = function (param) {
    return alert('calculating layout... Param: ' + param);
};
var lazyLayout = _.debounce(calculateLayout, 300);
$(window).resize(lazyLayout);

var createApplication = function (param) {
    return alert('creating application... Param: ' + param);
};
